...
%       reqml.analysis.make_step_summary_table.
%
% Default plot
%   x = omega_mean
%   y = q_mean
...
%
% Usage
%   fig = reqml.analysis.plot_q_vs_omega_grouped(T_step);
%
%   fig = reqml.analysis.plot_q_vs_omega_grouped( ...
%       T_step, ...
%       'ColorBy', 'REQ_M', ...
%       'FacetBy', 'SIM_WaveModel');

p = inputParser;
p.FunctionName = 'reqml.analysis.plot_q_vs_omega_grouped';
...
if logical(p.Results.SaveFigure)
    reqml.analysis.save_analysis_figure( ...
        fig, ...
        p.Results.OutputDir, ...
        p.Results.BaseName, ...
