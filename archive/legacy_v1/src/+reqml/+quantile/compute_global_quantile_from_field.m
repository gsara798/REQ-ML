...
req_global = req;
req_global.W2 = reqml.spectrum.hann2_circular_shrink( ...
...
[q_val, req_curve] = reqml.quantile.compute_quantile_from_patch( ...
    Uxz, cfg, req_global);

feat_pack = reqml.features.req_extract_patch_features( ...
