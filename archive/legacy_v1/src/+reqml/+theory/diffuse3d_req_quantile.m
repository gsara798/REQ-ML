...
% implementation reqml.theory.q_theory_REQ_discrete_shearUZ.

p = inputParser;
p.FunctionName = 'reqml.theory.diffuse3d_req_quantile';
...
out = reqml.theory.q_theory_REQ_discrete_shearUZ( ...
    ...
    'FieldType', 'Diffuse3D', ...
    'Plot', false);
out.source = "reqml.theory.q_theory_REQ_discrete_shearUZ";
