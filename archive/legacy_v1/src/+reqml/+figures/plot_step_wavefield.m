...
%
% Usage:
%   reqml.figures.plot_step_wavefield(sweep, 3);
%
% Requires:
...
[~, feat_cfg_i] = reqml.config.default_req_config(cfg_i, feat_cfg);
...
reqml.figures.apply_style(fig, ax);
reqml.figures.format_axis_ticks(ax, 1);
reqml.figures.format_colorbar_ticks(cb, 1);
