...
composition = ...
    reqml.inference.predict_composition( ...
        feature_table, ...
        models.composition);
...
for model_index = 1:numel(model_names)
    ...
    predictors = ...
        reqml.inference.validate_predictor_table( ...
            augmented_features, ...
            predictor_names, ...
            public_name);
    ...
    if any(~isfinite(q_raw))
        error( ...
            "reqml:InvalidQuantilePrediction", ...
