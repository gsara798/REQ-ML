...
manifest.schema_name = ...
    "reqml_angular_aperture_inplane_diagnostic_campaign_manifest";
...
fprintf("\nIn-plane diagnostic campaign materialization PASSED\n");
fprintf("==================================================\n");
fprintf("Conditions     : %d\n",height(conditions));
fprintf("Runs           : %d\n",height(runs));
fprintf("Directions     : %d\n",cfg.design.direction_count);
fprintf("Omega          : %.6f sr\n",cfg.design.solid_angle_sr);
