...
verifyEqual(testCase, result.request_count, 25);
verifyEqual(testCase, result.condition_count, 25);
verifyEqual(testCase, result.run_count, 50);
...
pairs = zeros(numel(conditions), 2);
