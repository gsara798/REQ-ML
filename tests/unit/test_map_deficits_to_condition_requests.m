...
verifyEqual(testCase, ...
    requests(1).target_grid_spacing_m, ...
    [0.25e-3 0.25e-3], ...
    AbsTol=1e-15);
...
verifyEqual(testCase, ...
    requests(1).target_sws_range_m_s, ...
    [2.5, 3.5], ...
    AbsTol=1e-12);

verifyEqual(testCase, ...
    requests(1).target_frequency_range_hz, ...
    [350, 450], ...
    AbsTol=1e-12);

verifyEqual(testCase, ...
    string({requests.condition_id})', ...
    ["batch_test_s02_f02_p01_d01_g01_001"; ...
     "batch_test_s03_f03_p03_d03_g03_002"]);
...
verifyEqual(testCase, ...
    string({requests.requested_cell_key})', ...
    [ ...
        "s02_f02_p01_d01_g01"
        "s03_f03_p03_d03_g03"
    ]);
