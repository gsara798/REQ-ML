...
verifyTrue(testCase, ...
    ismember("REQ_dkx_rad_m", ...
        summary.candidate_features));

verifyTrue(testCase, ...
    ismember("REQ_dkz_rad_m", ...
        summary.candidate_features));
...
examples.REQ_Nbins_effective = [31; 31; 61; 61];
examples.GRID_dx_m = [0.2e-3; 0.2e-3; 0.3e-3; 0.3e-3];
examples.GRID_dz_m = [0.2e-3; 0.2e-3; 0.4e-3; 0.4e-3];
examples.REQ_dkx_rad_m = [100; 100; 80; 80];
examples.REQ_dkz_rad_m = [100; 100; 60; 60];
