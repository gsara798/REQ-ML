...
[truth,state,target,options] = fixture();
target.requested_cell_key="s03_f01_p01_d02";
r=call_selector(truth,state,target,options);
...
summary=reqml.coverage.completeCoverageGrid(empty,o.SwsEdges, ...
    o.FrequencyEdges,o.PurityEdges,o.DiffusivityEdges);
...
target.requested_cell_key="s01_f01_p04_d02";
...
t=table(repmat(.6,n,1),repmat(1.75,n,1),repmat(220,n,1), ...
    repmat(16,n,1),repmat(.1,n,1),runs,conditions,VariableNames=[ ...
    "truth_material_purity","truth_cs_center_m_s", ...
    "campaign_frequency_hz","campaign_direction_count", ...
    "campaign_solid_angle_sr","campaign_run_id","campaign_condition_id"]);
end
