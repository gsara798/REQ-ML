...
purity = 21 / 25;
requested = struct("sws_bin",1,"frequency_bin",4,"purity_bin",2, ...
...
observed = table(zeros(0,1),zeros(0,1),zeros(0,1),zeros(0,1), ...
...
summary = reqml.coverage.completeCoverageGrid(observed, edges.sws, ...
    edges.frequency, edges.purity, edges.dnom);
