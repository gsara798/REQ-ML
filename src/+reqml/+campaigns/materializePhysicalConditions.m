...
% Temporary projected-3D compatibility field. This follows the previous
% approximate scaling 1, 4, 8 for N = 1, 16, 32. It will be replaced by
% the explicit Fibonacci direction set in the simulation framework.
field.in_plane_count = min( ...
    field.direction_count, ...
