...
%
% Usage:
%   RUN = reqml.config.load_run_config('default', 'RootDir', root_dir);
%
%   RUN = reqml.config.load_run_config( ...
%       'test_03_baseline', ...
%       'RootDir', root_dir);
%
...
p = inputParser;
p.FunctionName = 'reqml.config.load_run_config';
...
CFG = reqml.config.default_run_config();
...
[req_preview, feat_cfg] = reqml.config.default_req_config( ...
