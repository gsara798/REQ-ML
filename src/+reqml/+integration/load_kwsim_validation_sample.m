...
if string(sample.sample_schema_version) ~= "1.0"
    error( ...
        "reqml:UnsupportedKwsimSampleSchema", ...
...
if ~isequal(size(wavefield_zx), expected_size)
    error( ...
        "reqml:InvalidKwsimWavefieldSize", ...
