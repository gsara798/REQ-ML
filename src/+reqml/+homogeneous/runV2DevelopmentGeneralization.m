...
result=struct();
result.in_domain=reqml.homogeneous.trainQ0FromConfig(config_file, ...
...
result.alternating_sws=reqml.homogeneous.trainQ0FromConfig(config_file, ...
...
result.alternating_angular=reqml.homogeneous.trainQ0FromConfig(config_file, ...
