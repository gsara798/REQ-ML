    ...
    for frequency=frequencies'
        for spacing=spacings'
            geometry=reqml.homogeneous.computePatchGeometry( ...
                ...
                MinimumStridePixels=double( ...
                    config.patch_sampling.minimum_stride_pixels), ...
                StrideWindowFraction=double( ...
                    config.patch_sampling.stride_window_fraction), ...
                MinimumPlacementsPerAxis=double( ...
                    config.patch_sampling.minimum_placements_per_axis));
            for field_index=1:numel(fields)
                ...
                condition_rows{condition_ordinal}=table( ...
                    ...
                    string(field.name),double(field.direction_count), ...
                    double(field.in_plane_count),double(field.solid_angle_sr), ...
                    geometry.patch_width_px,geometry.patch_height_px, ...
                    geometry.stride_x_px,geometry.stride_z_px, ...
                    geometry.domain_x_m,geometry.domain_z_m, ...
                    realization_count, ...
                    VariableNames=["condition_ordinal","condition_id", ...
                    "cs_m_s","frequency_hz","dx_m","dz_m", ...
                    "field_regime","direction_count","in_plane_count", ...
...
if double(config.req.M)~=2 || double(config.req.cs_guess_m_s)~=3
...
if ~isequal(names(:),["single";"directional";"intermediate";"diffuse"])
