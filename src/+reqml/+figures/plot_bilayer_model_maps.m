...
p = inputParser;
p.FunctionName = 'reqml.figures.plot_bilayer_model_maps';
...
for i = 1:numel(models)
    ...
    [map_i, xc, zc] = reqml.figures.table_to_map_grid( ...
    ...
    xlabel(ax, 'x (cm)');
    ylabel(ax, 'z (cm)');
    reqml.figures.draw_roi_boxes(ax, roi_specs, ...
...
reqml.templates.apply_paper_style(fig, [], ...
