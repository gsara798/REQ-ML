...
candidates.GRID_dx_m = repmat( ...
    double(options.GridSpacingM(1)), ...
    candidate_count, ...
    1);

candidates.GRID_dz_m = repmat( ...
    double(options.GridSpacingM(2)), ...
    candidate_count, ...
    1);
...
for request_index = 1:height(requested)
    matches = ...
        ...
        candidates.coverage_discretization_bin == ...
            requested.discretization_bin(request_index);
